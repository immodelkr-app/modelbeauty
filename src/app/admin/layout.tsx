...
const NAV = [
  ...
  { href: "/admin/trials", label: "체험단 관리", icon: "🎁" },
  { href: "/admin/reviews", label: "구매 후기 관리", icon: "📝" },
  { href: "/admin/trial-reviews", label: "체험 후기 관리", icon: "📔" },
  { href: "/admin/coupons", label: "쿠폰 관리", icon: "🎟️" },
  { href: "/admin/push", label: "푸시 관리", icon: "🔔" },
  { section: "정산" },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const titles: Record<string, string> = {
      ...
      "/admin/vendors": "업체 관리",
      "/admin/trials": "체험단 관리",
      "/admin/reviews": "구매 후기 관리",
      "/admin/trial-reviews": "체험 후기 관리",
      "/admin/coupons": "쿠폰 관리",
      "/admin/push": "푸시 관리",
